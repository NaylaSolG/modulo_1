...
- Observen los valores que toma la variable `COMUNAS` en el listado que presenta el archivo **Comunas.xlsx**.Creen  una nueva columna llamada "departamento" que les sirva para unir la informacion con la de la base de los inmuebles 
